...
point4 points[NumNodes][NumVertices];
color4 colors[NumNodes][NumVertices];
vec3 normal[NumNodes][NumVertices];
...
void PLAYER::buffer()
{
	for (int i = 0; i < NumNodes; i++)
	{
		...
		glBufferData(GL_ARRAY_BUFFER, sizeof(points[i]) + sizeof(colors[i]) + sizeof(normal[i]),
		...
		glBufferSubData(GL_ARRAY_BUFFER, sizeof(points[i]) + sizeof(colors[i]), sizeof(normal[i]), normal[i]);
	}
}
...
{
	normal[idx][index] = normalize(cross(vertices[b] - vertices[a], vertices[c] - vertices[b]));
...
void torso()
{
	...
	glVertexAttribPointer(vNormal[Torso], 3, GL_FLOAT, GL_FALSE, 0,
		BUFFER_OFFSET(sizeof(points[Torso]) + sizeof(colors[Torso])));
...
void head()
{
	...
	glVertexAttribPointer(vNormal[Head], 3, GL_FLOAT, GL_FALSE, 0,
		BUFFER_OFFSET(sizeof(points[Head]) + sizeof(colors[Head])));
...
void right_upper_arm()
{
	...
	glVertexAttribPointer(vNormal[RightUpperArm], 3, GL_FLOAT, GL_FALSE, 0,
		BUFFER_OFFSET(sizeof(points[RightUpperArm]) + sizeof(colors[RightUpperArm])));
...
void right_lower_arm()
{
	...
	glVertexAttribPointer(vNormal[RightLowerArm], 3, GL_FLOAT, GL_FALSE, 0,
		BUFFER_OFFSET(sizeof(points[RightLowerArm]) + sizeof(colors[RightLowerArm])));
...
void left_upper_arm()
{
	...
	glVertexAttribPointer(vNormal[LeftUpperArm], 3, GL_FLOAT, GL_FALSE, 0,
		BUFFER_OFFSET(sizeof(points[LeftUpperArm]) + sizeof(colors[LeftUpperArm])));
...
void left_lower_arm()
{
	...
	glVertexAttribPointer(vNormal[LeftLowerArm], 3, GL_FLOAT, GL_FALSE, 0,
		BUFFER_OFFSET(sizeof(points[LeftLowerArm]) + sizeof(colors[LeftLowerArm])));
...
void right_upper_leg()
{
	...
	glVertexAttribPointer(vNormal[RightUpperLeg], 3, GL_FLOAT, GL_FALSE, 0,
		BUFFER_OFFSET(sizeof(points[RightUpperLeg]) + sizeof(colors[RightUpperLeg])));
...
void right_lower_leg()
{
	...
	glVertexAttribPointer(vNormal[RightLowerLeg], 3, GL_FLOAT, GL_FALSE, 0,
		BUFFER_OFFSET(sizeof(points[RightLowerLeg]) + sizeof(colors[RightLowerLeg])));
...
void left_upper_leg()
{
	...
	glVertexAttribPointer(vNormal[LeftUpperLeg], 3, GL_FLOAT, GL_FALSE, 0,
		BUFFER_OFFSET(sizeof(points[LeftUpperLeg]) + sizeof(colors[LeftUpperLeg])));
...
void left_lower_leg()
{
	...
	glVertexAttribPointer(vNormal[LeftLowerLeg], 3, GL_FLOAT, GL_FALSE, 0,
		BUFFER_OFFSET(sizeof(points[LeftLowerLeg]) + sizeof(colors[LeftLowerLeg])));
